export default function PromoBanner() {
  return (
    <section className="bg-zinc-50 px-5 py-14 sm:px-8 sm:py-20">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-lg border border-white/5 bg-[#08080a] text-white shadow-2xl shadow-zinc-950/15 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="relative min-h-80 overflow-hidden bg-[radial-gradient(circle_at_66%_26%,rgba(214,204,188,0.24),transparent_28%),linear-gradient(135deg,#151518,#303034_55%,#0f172a)]">
